...
import com.xiaohe.system.service.ISysPostService;
import com.xiaohe.system.service.ISysRoleService;
import com.xiaohe.system.service.ISysUserService;

import static com.xiaohe.common.config.XiaoHeConfig.getDefaultPassWord;
...
//    @PreAuthorize("@ss.hasPermi('system:user:add')")
    ...
    public AjaxResult add(@Validated @RequestBody SysUser user)
    {
        ...
        {
            return AjaxResult.error(MessageUtils.message("user.add.fail", user.getUserName(), MessageUtils.message("user.name.exist")));
        }
        else if (StringUtils.isNotEmpty(user.getPhonenumber())
                && UserConstants.NOT_UNIQUE.equals(userService.checkPhoneUnique(user)))
        {
            return AjaxResult.error(MessageUtils.message("user.add.fail", user.getUserName(), MessageUtils.message("user.phone.exist")));
        }
        else if (StringUtils.isNotEmpty(user.getEmail())
                && UserConstants.NOT_UNIQUE.equals(userService.checkEmailUnique(user)))
        {
            return AjaxResult.error(MessageUtils.message("user.add.fail", user.getUserName(), MessageUtils.message("user.email.exist")));
        }
        user.setCreateBy(getUsername());
        System.out.println(getDefaultPassWord());
        user.setPassword(SecurityUtils.encryptPassword(getDefaultPassWord()));
...
//    @PreAuthorize("@ss.hasPermi('system:user:remove')")
    ...
    public AjaxResult remove(@PathVariable Long[] userIds)
    {
        ...
        {
            return error(MessageUtils.message("user.current.delete.error"));
        }
...
//    @PreAuthorize("@ss.hasPermi('system:user:edit')")
     ...
     */
//    @PreAuthorize("@ss.hasPermi('system:user:edit')")
    @Log(title = "查询所有用户", businessType = BusinessType.GRANT)
    @GetMapping("/userList")
   ...
   ;
        return AjaxResult.success( userService.getUserInfo(userId));
    }
